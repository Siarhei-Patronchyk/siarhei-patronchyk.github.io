...
angular.module('appsngen.portal.sandbox.datasource.controllers')

.controller('SandboxDataSourceCtrl', function($scope, $location, authSession, dataSourceService, PagingModel) {
