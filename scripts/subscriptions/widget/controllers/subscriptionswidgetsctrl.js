...
angular.module('appsngen.portal.subscriptions.widget.controllers')

.controller('SubscriptionsWidgetsCtrl', function($scope, $location, authSession, widgetService, PagingModel) {
